    ...
    content: (
      <>
        ...
        <DataTable data={[
          ...
          { label: "Status", value: "✓ OPEN / ⚠ CLOSED" },
        ]} />
        <Divider />
        <Line pink>🎵 Now playing: [Background music/ambiance]</Line>
    ...
    content: (
      <>
        ...
        <Section title="RECENT TRANSACTIONS (Last 24h):">
          <Line neon>00:00 → Withdrawal: Amount¤</Line>
          <Line neon>00:00 → Withdrawal: Amount¤</Line>
          <Line yellow>00:00 → Failed transaction (reason)</Line>
        </Section>
      </>
    ),
    related_commands: {
      hack_atm: {
        ...
        content: (
          <>
            ...
            <Divider />
            <Line yellow>Available cash: [amount]¤</Line>
  ...
  vending_machine: {
    content: (
      <>
        ...
        <Divider />
        <Section title="PRICING:">
          <Line cyan>Standard items: 5-8¤</Line>
          <Line cyan>Premium items: 10-15¤</Line>
        </Section>
        <Divider />
        <Line yellow>Last restock: X days ago</Line>
        <Line red>Cash box: Estimated [amount]¤</Line>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <Section title="BLIND SPOTS:">
          <Line yellow>→ Area not visible from this angle</Line>
          <Line yellow>→ Obstruction or limitation</Line>
        </Section>
      </>
    ),
    related_commands: {
  ...
  digital_safe: {
    content: (
      <>
        ...
        <Line red>Estimated contents value: [amount]¤</Line>
      </>
    ),
    related_commands: {
      crack_safe: {
        ...
        content: (
          <>
            ...
            <Section title="CONTENTS:">
              <Line neon>→ Credchips: [amount]¤</Line>
              <Line neon>→ Item 1: Description</Line>
              <Line neon>→ Item 2: Description</Line>
              <Line yellow>→ Documents: Brief description</Line>
            </Section>
          </>
        ),
      },
