...
const CLUB = {
  ...
  location: "Converted storm chamber (Ports district)",
  owner: "Stone Eels (gang operation)",
  function: "Music venue & neutral ground",
  hours: "20:00 - 06:00 (every night)",
  capacity: "40-60 comfortable, ~100 packed",
};

const LEADERSHIP = [
  {
    name: "Saša",
    role: "Primary Leadership",
    component: (
      <PersonnelFile
...
const PASSWORDS = {
  internal: { pw: "serpent", hint: "The Stone Eels gang symbol - what kind of creature?", hintStrength: 2 },
  layout: { pw: "storm", hint: "What the club was before - a water overflow chamber", hintStrength: 2 },
  vip: { pw: "clearance", hint: "You don't have it", hintStrength: 3 },
  safe: { pw: "eels", hint: "The gang's name (plural)", hintStrength: 1 },
  operations: { pw: "alliansen", hint: "The megacorp trying to take over Ports", hintStrength: 2 },
  leadership: { pw: "sasa", hint: "The gang leader's first name", hintStrength: 3 },
};
        ...
        content: (
          <>
            ...
            <Section title="OPERATING HOURS:">
              <Line neon>Open: {CLUB.hours}</Line>
            ...
            content: (
              <>
                ...
                <Section title="GROUND FLOOR (Public):">
                  ...
                  <KeyValue label="Capacity" value={CLUB.capacity} />
                </Section>
                <Divider />
          ...
          access_stone_eels_operations: {
            ...
            related_commands: {
                ...
                content: (
                  <Box color="pink">
                    ...
                    <DataTable data={[
                      ...
                      { label: "Headquarters", value: CLUB.name },
              ...
              "Leadership Files (Stone Eels)": {
                ...
                related_commands: Object.fromEntries(
                  LEADERSHIP.map(p => [p.name, { content: p.component }])
                ),
              },
            },
          },
...
//         ),
//         related_commands: {
//           query_cave_club_facility_layout: {
//             password: {
//               pw: "storm",
...
//           query_cave_club_security_systems: {
//             content: (
//               <>
//                 <Line smoke large bold>[SECURITY SYSTEMS]</Line>
//                 <Divider />
...
//           query_cave_club__vip_management: {
//             password: {
//               pw: "clearance",
...
//           query_cave_club__incident_reports: {
//             content: (
//               <>
//                 <Line smoke large bold>[INCIDENT LOG]</Line>
//                 <Line cyan>Last 7 days</Line>
...
//             ),
//             related_commands: {
//               query_stone_eels_territory_status: {
//                 content: (
//                   <Box color="pink">
//                     <Line pink large bold>[STONE EELS - TERRITORY STATUS]</Line>
//                     <Divider color="pink" />
...
//               query_stone_eels_leadership_files: {
//                 password: {
//                   pw: "sasa",
