  ...
  "Steel Jackhammer's Penthouse": {
    ...
    related_commands: {
      ...
      "Penthouse Layout": {
        content: (
          <Box color="neon">
            <Section title="STEEL JACKHAMMER'S PENTHOUSE - UNIT 4201" center>
              <Line red xsmall bottom pulse>CONFIDENTIAL // KILLMATCH ATHLETE RESIDENCE</Line>
              <Line neon small>Floor 42 - Central Plaza Tower</Line>
            </Section>
            <RetComImage
              src={penthouseBlueprint}
              alt="Steel Jackhammer Penthouse Layout"
              theme="blue"
              borderColor="rgba(219, 234, 254, 0.7)"
              style={{ marginTop: "1rem", width: "100%" }}
            />
            <Line neon xsmall style={{ marginTop: "0.5rem", textAlign: "center", opacity: 0.5 }}>
              For reference only — not an exact representation
            </Line>
            <Divider />
            <Line cyan bold>ROOM DIRECTORY:</Line>
            <Line neon>• HALLWAY - Entry point, constant guest/dealer traffic</Line>
            <Line neon>• GUEST ROOM - Rarely used storage, Faceblock in drawer</Line>
            <Line neon>• MASTER BEDROOM - Soundproof, private balcony, wall safe, closet stash</Line>
            <Line neon>• KITCHEN - Smart appliances, stocked fridge, Blackout in freezer</Line>
            <Line neon>• MAIN LIVING AREA - Central party hub, Cyber-Lich painting, hidden safe</Line>
            <Line neon>• TIGER ROOM - Modified guest room, cage opens to main area</Line>
            <Line neon>• MAIN BALCONY - Pool, hot tub, outdoor seating</Line>
            <Line neon>• SPA - Hot tub, sauna, drowsy guests</Line>
            <Line neon>• GYM - Weights, sparring cydroid (MAXIMUM DIFFICULTY)</Line>
            <Divider />
            <Line yellow bold>STEEL JACKHAMMER'S CURRENT LOCATION:</Line>
            <Line yellow>Day 3+ of continuous party - moves between rooms randomly (D4):</Line>
            <Line yellow>1. Master Bedroom</Line>
            <Line yellow>2. Main Balcony</Line>
            <Line yellow>3. Tiger Room</Line>
            <Line yellow>4. Main Living Area</Line>
            <Line smoke small>May move if events call his attention elsewhere</Line>
            <Divider />
            <Line red>⚠ Party ongoing - security minimal but 8 VIP killmatch athletes present</Line>
          </Box>
        ),
      },
            ...
            content: (
              ...
              >
                ...
                <InsetBox title="D8 VIP ROSTER:">
                  ...
                  <Line smoke>Member of Arvtagarna (Heirs of Kergoz breakout group). C-list veteran, bored of circus.</Line>
            ...
            content: (
              ...
              >
                ...
                <InsetBox title="D6 RANDOM EVENTS:">
                  ...
                  <Line>The gene-spliced big cats are let loose into the main area.</Line>
                  ...
                  <Line yellow bold>5. DRONE-SUIT PUNKS (EARLY)</Line>
                  <Line>Four punks in drone suits land on main balcony.</Line>
                  ...
                  <Line yellow bold>6. DRONE-SUIT PUNKS (LATE)</Line>
                  <Line>Same crew, different timing. Still not paid enough to die.</Line>
                  <Line smoke small>Use this if event 5 already happened — they come back for another try.</Line>
                </InsetBox>
              </MaintenanceAccess>
            ),
          },
          ...
          "Steel Jackhammer": {
            content: (
              <MaintenanceAccess
                ...
                deviceModel="Combat Profile"
                deviceId="TARGET-STEEL-01"
                firmwareVersion="v1.0.0"
                systemStatus="ACTIVE"
                notes={[
                  "Killmatch heavyweight division",
                  "Recently had both legs ripped off by 5 Kroks — continued fighting (50M+ views)",
                  "New chrome legs from Alliansen Inc. sponsor (allegedly stolen design)",
                  "Day 3+ of recovery party — not actually resting",
                  "Moves between Master Bedroom, Main Balcony, Tiger Room, Main Living Area",
                ]}
              >
                <Divider />
                <InsetBox title="COMBAT STATS:">
                  <Line red bold>HP: 12 | Morale: 8 | No armor</Line>
                  <Line red>Weapon: Jackhammer Punch (D6)</Line>
                  <Line yellow>Special: On 5+ damage, attack again (chained attacks)</Line>
                </InsetBox>
                <InsetBox title="CHROME LEG EXTRACTION:">
                  <Line cyan>Target must be incapacitated first</Line>
                  <Line cyan>DR14 Knowledge test required for safe removal</Line>
                  <Line cyan>Failure causes D8 damage to legs — payment deduction</Line>
                  <Line cyan>Witness reactions depend on PC behaviour during party</Line>
                </InsetBox>
        ...
        content: (
          <NetworkDevices
            ...
            devices={[
              ...
              { name: "Camera System", ip: "192.168.1.20-26", type: "Surveillance", status: "ONLINE", lastSeen: "Active now" },
              ...
              { name: "Tiger Room Cage Gate", ip: "192.168.1.85", type: "Security", status: "ONLINE", lastSeen: "Active now" },
      ...
      "Hallway": {
        content: (
          <MaintenanceAccess
            ...
            notes={[
              "Guests and deliveries coming and going constantly",
              "Dealers rotating — as soon as one leaves, another shows up",
              "Two guards posted outside in building hallway",
              "No camera (privacy — building hallway outside unit)",
            ]}
          >
            <Divider />
            <InsetBox title="CURRENT ACTIVITY:">
              <Line cyan>Constant flow of party guests</Line>
              <Line cyan>Multiple dealers (drugs, stims, party supplies)</Line>
      ...
      "Guest Room": {
        content: (
          <MaintenanceAccess
            ...
            systemStatus="UNUSED"
            notes={[
              "Rarely used — mostly storage",
              "Closet full of boxes (pots, books, tuxedo — all unused)",
              "Drawer contains two packs of Faceblock",
            ]}
          >
            <Divider />
        ...
        content: (
          <MaintenanceAccess
            ...
            notes={[
              ...
              "Private balcony attached — seating, city view, no pool",
              "Small wall safe, closet with backpack stash",
            ]}
          >
            <Divider />
            <InsetBox title="ROOM FEATURES:">
              ...
              <Line cyan>Door to private balcony (no camera)</Line>
        ...
        content: (
          <MaintenanceAccess
            ...
            notes={[
              ...
              "Auto-reorder disabled — party consumption too high",
            ]}
          >
            <Divider />
            <InsetBox title="CONNECTED APPLIANCES:">
              <Line neon>Smart Fridge (stocked with drinks)</Line>
              <Line neon>Smart Freezer (Blackout doses + misc)</Line>
              <Line neon>Coffee Machine (unused — hidden compartment)</Line>
              <Line neon>Smart Oven (pristine, never used)</Line>
              <Line neon>Dishwasher (running constantly)</Line>
            </InsetBox>
          </MaintenanceAccess>
        ),
        related_commands: {
          "Smart Fridge": {
            content: (
              <SmartFridge
                ...
                temperature={38}
                physicalItems={[
                  { id: "fridge_beer", label: "Beer x48 bottles", description: "Various brands" },
                  { id: "fridge_energy", label: "Energy Drinks x32 cans", description: "Party fuel" },
                  { id: "fridge_synth_juice", label: "Synth-juice x12 bottles", description: "Synthetic fruit juice" },
                  { id: "fridge_cocktails", label: "Pre-mixed Cocktails x18 cans", description: "Ready to drink" },
                  { id: "fridge_water", label: "Water x24 bottles", description: "Mostly untouched" },
                  { id: "fridge_protein", label: "Protein Packs x8", description: "Meal replacement" },
                  { id: "fridge_takeout", label: "Leftover Takeout", description: "Days old, probably bad" },
                ]}
                freezerItems={[
                  {
                    id: "freezer_blackout",
                    label: "Blackout x10 doses",
                    description: "Sedative — kept frozen for preservation",
                    value: 1500,
                    isCredits: false
                  },
                  { id: "freezer_ice_cream", label: "Ice Cream x3 containers", description: "Various flavors" },
                  { id: "freezer_pizza", label: "Frozen Pizza x4 boxes", description: "Untouched" },
                  { id: "freezer_ice", label: "Ice x2 bags", description: "For drinks" },
                ]}
                freezerTemp={0}
                notes="Auto-reorder disabled — party consumption too high. Fridge gave up trying."
              />
            ),
          },
            ...
            content: (
              <MaintenanceAccess
                ...
                notes={[
                  ...
                  "Bean supply: Full",
                  "Water: Full",
                  "Side panel shows signs of tampering",
                ]}
              >
                <Divider />
      ...
      "Main Living Area": {
        content: (
          <MaintenanceAccess
            ...
            deviceId="LIVING-4201"
            firmwareVersion="v2.0.0"
            systemStatus="PARTY MODE ACTIVE"
            notes={[
              "Central party hub — 8-10 people visible constantly",
              "Music blasting, gaming tournament in progress",
              "Mix of flesh guests and holo-avatars",
              "Connects to kitchen, tiger room, main balcony",
              "Cyber-Lich painting slightly crooked on wall",
            ]}
          >
            <Divider />
            <InsetBox title="CURRENT SCENE:">
              <Line cyan>Rounded central table with drinks</Line>
              <Line cyan>Gaming tournament on big screen</Line>
              <Line cyan>Someone passed out on couch (still there)</Line>
              <Line cyan>Cyber-Lich painting visible on wall — slightly crooked</Line>
            </InsetBox>
            <InsetBox title="ENTERTAINMENT SYSTEMS:">
              <Line neon>Jukebox (loud techno playing)</Line>
              <Line neon>Holo projectors (4 units)</Line>
            ...
            content: (
              ...
              >
                ...
                <InsetBox title="IN-GAME WALLET DETECTED:">
                  ...
                  <Line yellow>Conversion rate: ~25% (11,875¤ real value on black market)</Line>
                </InsetBox>
              </GameConsole>
            ),
          },
          ...
          "Holo Projectors": {
            content: (
              <MaintenanceAccess
                ...
                systemStatus="ACTIVE"
                notes={[
                  "Projectors across penthouse — majority of guests are holo-avatars",
                  "Real guests mixed with projections",
                  "No projectors on balconies (by design)",
                ]}
              >
                <Divider />
                <InsetBox title="ACTIVE PROJECTORS:">
                  <Line neon>Main Living Area: 4 units</Line>
                  <Line neon>Master Bedroom: 2 units</Line>
                  <Line neon>Gym: 1 unit (training displays)</Line>
                  <Line neon>Spa: 2 units (relaxation visuals)</Line>
                </InsetBox>
              ...
              "Hidden Safe": {
                ...
                content: (
                  <Safe
                    ...
                    location="Main Living Area - Behind Cyber-Lich painting"
                    owner="Steel Jackhammer"
                    ...
                    notes="Can be sold to competitor's media or PR agents for up to 9,000¤. Publishing this ends Steel Jackhammer's career/life if it hasn't ended already. He probably doesn't even know what he has."
                    stealing={true}
                  />
                ),
              },
      ...
      "Tiger Room": {
        content: (
          <MaintenanceAccess
            ...
            systemStatus="ACTIVE"
            notes={[
              "Modified guest room — cage structure occupies most of space",
              "Cage gate opens directly into main living area",
              "Two gene-spliced big cats: Stripe and Shade",
              "Structural modification approved Nov 2066",
              "Cage inspection overdue (see building maintenance log)",
            ]}
          >
            <Divider />
            <InsetBox title="OCCUPANTS:">
              ...
              <Line yellow>Behavior: Aggressive when startled or if anyone panics nearby</Line>
            </InsetBox>
          </MaintenanceAccess>
        ),
        related_commands: {
      ...
      "Main Balcony": {
        content: (
          <MaintenanceAccess
            ...
            deviceId="BALCONY-MAIN-4201"
            firmwareVersion="v1.0.0"
            systemStatus="OPERATIONAL"
            notes={[
              "Large outdoor terrace off main living area",
              "Heated pool and hot tub",
              "Outdoor seating areas",
              "Supposedly bulletproof perimeter glazing",
          ...
          >
            ...
            <InsetBox title="FEATURES:">
              ...
              <Line smoke small>It's a long way down.</Line>
            </InsetBox>
          </MaintenanceAccess>
        ),
        related_commands: {
        ...
        content: (
          <MaintenanceAccess
            ...
            notes={[
              ...
              "Sparring cydroid set to MAXIMUM DIFFICULTY",
              "Mirror wall with AR feedback",
            ]}
          >
            <Divider />
            <InsetBox title="EQUIPMENT:">
              <Line cyan>Weight machines</Line>
            ...
            content: (
              ...
              >
                ...
                <InsetBox title="CYDROID STATS:">
                  <Line red bold>HP: 14 | Morale: — | Armor: Metal (-D4)</Line>
                  <Line red>Attack: Kick/Punch (D6)</Line>
                  <Line red>Engagement zone: Training ring only (until admin override)</Line>
                </InsetBox>
                <InsetBox title="ADMIN CONTROL OPTIONS:">
                  ...
                  <Line yellow>Set specific target</Line>
        ...
        content: (
          ...
          >
            ...
            <InsetBox title="OVERRIDE OPTIONS:">
              ...
              <Line yellow>Lock windows/balcony doors remotely</Line>
            </InsetBox>
            <InsetBox title="TACTICAL USES:">
