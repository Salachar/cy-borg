          ...
          "Steel Jackhammer Intel": {
            content: (
              <PersonnelFile
                ...
                notes={[
                  "Recent viral moment: Both legs ripped off by 5 Kroks, continued fighting",
                  "New chrome legs installed 2 weeks ago (Alliansen Inc. prototype)",
                  "Currently hosting multi-day recovery party (Day 3+)",
                  "Signature move: Jackhammer Punch (rapid chained attacks)",
