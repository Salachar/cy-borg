...
export default {
  ...
  argTypes: {
    ...
    boardName: {
      control: 'text',
      description: 'Name of the bulletin board',
    },
    location: {
      control: 'text',
      description: 'Physical location of the board',
    },
    lastUpdate: {
      control: 'text',
      description: 'When board was last updated',
    },
    posts: {
      control: 'object',
    ...
    warnings: {
      control: 'object',
      description: 'Array of warning objects',
    },
    vibe: {
      control: 'text',
      description: 'Overall neighborhood atmosphere',
    },
  },
};
