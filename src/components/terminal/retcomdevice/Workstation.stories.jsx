...
export default {
  ...
  argTypes: {
    ...
    status: {
      control: 'select',
      options: ['LOCKED', 'IDLE', 'ACTIVE', 'AWAY'],
      description: 'Workstation status',
    },
    lastActivity: {
      control: 'text',
      description: 'Time string of last activity',
    },
    openTabs: {
      control: 'object',
      description: 'Array of browser tab objects',
    },
    recentFiles: {
      control: 'object',
      description: 'Array of recent file objects',
    },
    emails: {
      control: 'number',
