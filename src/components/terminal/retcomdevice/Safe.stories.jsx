...
export default {
  ...
  argTypes: {
    ...
    model: {
      control: 'text',
      description: 'Safe model number',
    },
    location: {
      control: 'text',
      description: 'Where the safe is located',
    },
    owner: {
      control: 'text',
      description: 'Owner name and occupation',
    },
    security: {
      control: 'text',
    ...
    lastAccess: {
      control: 'text',
      description: 'When it was last accessed',
    },
    physical: {
      control: 'object',
      description: 'Array of physical contents objects',
    },
    digital: {
      control: 'object',
      description: 'Array of digital contents objects',
    },
    notes: {
      control: 'text',
