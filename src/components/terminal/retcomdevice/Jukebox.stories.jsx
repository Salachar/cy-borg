...
export default {
  ...
  argTypes: {
    model: {
      control: 'text',
      description: 'Jukebox model',
    },
    location: {
      control: 'text',
      description: 'Where the jukebox is located',
    },
    cost: {
      control: 'text',
      description: 'Price per song (optional if using musicType)',
    },
    musicType: {
      control: 'text',
      description: 'Music category from audioTracks (e.g., "jazz", "cyberpunk")',
    },
    trackLimit: {
      control: 'number',
      description: 'Number of tracks to load when using musicType (default: 4)',
    },
    songs: {
      control: 'object',
      description: 'Array of song objects (overrides musicType)',
    },
  },
};
