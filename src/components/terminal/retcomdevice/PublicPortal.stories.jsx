...
export default {
  ...
  argTypes: {
    ...
    tagline: {
      control: 'text',
      description: 'Catchphrase/slogan',
    },
    network: {
      control: 'text',
    ...
    statusColor: {
      control: 'select',
      options: ['neon', 'yellow', 'red'],
      description: 'Status color',
    },
    nowPlaying: {
      control: 'text',
      description: 'What\'s currently playing/happening',
    },
    notes: {
      control: 'object',
      description: 'Array of info strings',
    },
    theme: {
      control: 'select',
      options: ['friendly', 'party', 'casual'],
