...
export default {
  ...
  argTypes: {
    ...
    systemName: {
      control: 'text',
      description: 'Recognition system name',
    },
    location: {
      control: 'text',
    ...
    lastCalibration: {
      control: 'text',
      description: 'When system was last calibrated',
    },
    confidence: {
      control: 'text',
      description: 'System confidence threshold',
    },
    scans: {
      control: 'object',
      description: 'Array of scan attempt objects',
    },
  },
};
