...
export default {
  ...
  argTypes: {
    title: {
      control: 'text',
      description: 'Mission/briefing title',
    },
    issuer: {
      control: 'text',
      description: "Who's giving the brief",
    },
    classification: {
      control: 'select',
      options: ['CLASSIFIED', 'CONFIDENTIAL', 'RESTRICTED', 'UNCLASSIFIED'],
      description: 'Classification level',
    },
    primary: {
      control: 'object',
      description: 'Array of primary objective objects',
    },
    secondary: {
      control: 'object',
      description: 'Array of secondary objective objects',
    },
    intel: {
      control: 'object',
      description: 'Array of intelligence strings',
    },
    payment: {
      control: 'object',
      description: 'Array of payment/reward strings',
    },
    warnings: {
      control: 'object',
      description: 'Array of warning strings',
    },
    footer: {
      control: 'text',
