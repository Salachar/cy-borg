...
export default {
  ...
  argTypes: {
    command: {
      control: 'text',
      description: 'Command or context for password entry',
    },
    password: {
      control: 'text',
      description: 'The correct password',
    },
    hint: {
      control: 'text',
      description: 'Hint text to help user',
    },
    hintStrength: {
      control: 'select',
      options: [1, 2, 3],
      description: 'Hint strength level (1=minimal, 2=shows length, 3=shows character frequency)',
    },
  },
};
