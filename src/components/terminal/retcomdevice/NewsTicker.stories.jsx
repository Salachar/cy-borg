...
export default {
  ...
  argTypes: {
    interval: {
      control: 'number',
      description: 'How long to display each event in ms',
    },
    filterType: {
      control: 'select',
      options: ['ALL', 'CORP_NEWS', 'STREET_INTEL', 'GANG_CHATTER', 'SEC_OPS', 'SYSTEM'],
      description: 'Filter by event type',
    },
    showTypeLabel: {
      control: 'boolean',
      description: 'Show the event type badge',
    },
    autoScroll: {
      control: 'boolean',
      description: 'Auto-advance to next event',
    },
  },
};
