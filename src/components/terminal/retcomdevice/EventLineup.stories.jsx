...
export default {
  ...
  argTypes: {
    ...
    date: {
      control: 'text',
      description: 'Date or "Tonight"',
    },
    updateFrequency: {
      control: 'text',
      description: 'How often lineup updates',
    },
    performances: {
      control: 'object',
    ...
    djs: {
      control: 'object',
      description: 'Array of DJ objects',
    },
    entry: {
      control: 'object',
      description: 'Entry/pricing information',
    },
    tagline: {
      control: 'text',
      description: 'Venue motto/tagline',
    },
    theme: {
      control: 'select',
      options: ['club', 'concert', 'bar'],
