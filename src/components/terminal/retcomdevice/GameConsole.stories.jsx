...
export default {
  ...
  argTypes: {
    model: {
      control: 'text',
      description: 'Console model name',
    },
    owner: {
      control: 'text',
      description: "Console owner's gamertag",
    },
    gameLoaded: {
      control: 'text',
      description: 'Game currently in console',
    },
    friends: {
      control: 'object',
      description: 'Array of friend objects with name, status, and game',
    },
  },
};
