...
export default {
  ...
  argTypes: {
    ...
    model: {
      control: 'text',
      description: 'ATM model number',
    },
    location: {
      control: 'text',
      description: 'Physical location of the ATM',
    },
    network: {
      control: 'text',
      description: 'Banking network name',
    },
    accountHolder: {
      control: 'text',
      description: 'Name of account currently accessed',
    },
    balance: {
      control: 'text',
      description: 'Current account balance display',
    },
    recentTransactions: {
      control: 'object',
      description: 'Array of recent transaction strings',
    },
    lastService: {
      control: 'text',
      description: 'When the ATM was last serviced',
    },
  },
};
